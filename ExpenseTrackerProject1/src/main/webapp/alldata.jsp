...
<head>
    ...
    <style>
        ...
        .table tr:hover {
            ...
            background-color: #e2e6ea; /* Hover effect for table rows */
        }
        .table td {
            text-align: center;
        ...
        .table-striped tbody tr:nth-of-type(even) {
            background-color: #e9ecef; /* Light background for even rows */
        }
        .table-striped tbody tr:hover {
            background-color: #d1ecf1; /* Hover effect for table rows */
            color: #0c5460; /* Text color on hover */
        }
    </style>
</head>
<body background="public/images/bank.jpg">
    <div class="container">
